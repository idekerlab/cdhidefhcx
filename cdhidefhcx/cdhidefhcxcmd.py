...
def main(args):
    ...
    :return: return value of :py:meth:`cdhidefhcx.runner.CdhidefhcxRunner.run`
    ...
    Invokes run() method on CdhidefhcxRunner

    """.format(version=cdhidefhcx.__version__)
    theargs = _parse_arguments(desc, args[1:])
    theargs.program = args[0]
    theargs.version = cdhidefhcx.__version__

    try:
        _setup_logging(theargs)
        return CdhidefhcxRunner(theargs.exitcode).run()
