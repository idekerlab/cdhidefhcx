...
# -*- coding: utf-8 -*-
#
# cdhidefhcx documentation build configuration file, created by
...
init_file = os.path.join('..', 'cdhidefhcx', '__init__.py')
...
htmlhelp_basename = 'cdhidefhcxdoc'
...
latex_documents = [
    (master_doc, 'cdhidefhcx.tex',
     u'cdhidefhcx Documentation',
